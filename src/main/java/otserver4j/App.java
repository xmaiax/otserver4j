...
@lombok.extern.slf4j.Slf4j @org.springframework.boot.autoconfigure.SpringBootApplication
public class App implements org.springframework.web.servlet.config.annotation.WebMvcConfigurer {
  ...
  public void startedMessage() { log.info("Rest service starting in port: {}", this.webServerPort); }
